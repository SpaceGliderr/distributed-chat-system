...
//     case class UserChatSessionsResponse(sessions: Array[ActorRef[Topic[ClientManager.Command]]]) extends Command
...
//                         ClientManager.ListingResponse(listing)
...
//                         println(s"Client received message: $content")
//                         Behaviors.same
//                     case UserChatSessionsResponse(sessions) =>
//                         println(s"Client received UserChatSessionsResponse: ${sessions.toString}")
//                         Behaviors.same
//                 }
//             }
//         }
